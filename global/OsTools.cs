...
public partial class OsTools : Node
{
    ...
    public Error CreateFileShortcut(string description, string sourcePath)
    {
        ...
        {
            case "Windows":
                return CreateFileShortcutWindows(description, sourcePath);
            case "Linux":
                return CreateFileShortcutLinux(description, sourcePath);
            default:
    ...
    private Error CreateFileShortcutWindows(string description, string sourcePath)
    {
        var script = $@"
    ...
    private Error CreateFileShortcutLinux(string description, string sourcePath)
    {
        var script = $@"
            [Desktop Entry]
            Name={description}
